...
Define immutable analytic underline and strikethrough geometry that can be derived after layout and consumed by any renderer without owning fonts, outlines, or renderer-specific objects.
