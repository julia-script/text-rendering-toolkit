...

{
  ...
  fixtures.push(
    fixture({
      ...
      glyphs: [placed(a, 0, 0, 0), placed(b, 14, 0, 0, { fontKey: tallFont.fontKey, styleKey: 'large' })],
...

{
  ...
  fixtures.push(
    fixture({
      ...
      glyphs: [placed(a, 0, 0, 0), placed(b, 10, 0, 0, { styleKey: 'emphasis', variations: { wght: 700 } })],
